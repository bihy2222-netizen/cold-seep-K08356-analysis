...
outdir <- '/Users/catherine/Downloads/aioA 蛋白序列建树/TPM_combo_figure_20260728/reference_style_K08356_56sample_boxplot'
...
pB <- ggplot(sample_box_long, aes(sample, logTPM, fill=habitat)) +
  ...
  labs(title='D  Host-MAG abundance across 56 samples by K08356 subclass',
...
pdf_file <- file.path(outdir, 'reference_style_K08356_56sample_boxplot.pdf')
png_file <- file.path(outdir, 'reference_style_K08356_56sample_boxplot.png')
svg_file <- file.path(outdir, 'reference_style_K08356_56sample_boxplot.svg')
