...
python3 "$ROOT/scripts/make_itol_order_gene_island_outputs.py" \
  ...
  --metadata "$ROOT/input/tip_metadata.tsv" \
  --arrow-manifest "$ROOT/input/small_tree_gene_arrow_manifest.tsv" \
  ...
  --strict-qc "$ROOT/input/strict_synteny_qc_48_reclassified.tsv" \
